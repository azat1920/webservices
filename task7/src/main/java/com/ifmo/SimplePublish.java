...
public class SimplePublish {
     ...
     * with this code)
     *
     * @param bn - the name of the business
     * @@param nk - the service name
     * @param lk - the wsdl link
     */
    public void publish(String bn, String sn, String lk) {
        try {

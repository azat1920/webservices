 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://ifmo.com/", wsdlLocation = "http://localhost:12344/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://ifmo.com/", "PersonService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:12344/PersonService?wsdl");
    ...
    public PersonWebService getPersonWebServicePort() {
        return super.getPort(new QName("http://ifmo.com/", "PersonWebServicePort"), PersonWebService.class);
    }
    ...
    public PersonWebService getPersonWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ifmo.com/", "PersonWebServicePort"), PersonWebService.class, features);
    }

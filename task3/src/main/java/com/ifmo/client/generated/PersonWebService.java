...
public interface PersonWebService {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getPersonsById", targetNamespace = "http://ifmo.com/", className = "com.ifmo.client.generated.GetPersonsById")
    @ResponseWrapper(localName = "getPersonsByIdResponse", targetNamespace = "http://ifmo.com/", className = "com.ifmo.client.generated.GetPersonsByIdResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "checkPersonExistingById", targetNamespace = "http://ifmo.com/", className = "com.ifmo.client.generated.CheckPersonExistingById")
    @ResponseWrapper(localName = "checkPersonExistingByIdResponse", targetNamespace = "http://ifmo.com/", className = "com.ifmo.client.generated.CheckPersonExistingByIdResponse")
    public void checkPersonExistingById(

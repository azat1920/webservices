 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://ifmo.com/", wsdlLocation = "http://localhost:12345/PersonService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:12345/PersonService?wsdl");
